...
function App() {
    ...
    const interval = setInterval(async () => {
      ...
      try {
        ...
        const res = await axios.get(
          "http://76d746d1-9c5d-494e-a519-516ce5f4f920.up.railway.app/reminders",
          {
            params: {
              userid: isloginuser
            }
        ...
        for (const task of res.data) {
          ...
          await axios.patch(
            `http:////76d746d1-9c5d-494e-a519-516ce5f4f920.up.railway.app/reminders/${task._id}`
          );
  ...
  const getAISuggestion = async (taskText) => {
    try {
      const res = await axios.get("http:////76d746d1-9c5d-494e-a519-516ce5f4f920.up.railway.app/getaisuggestions", {
  ...
  const gettodaytask = async () => {
    ...
    try {
      ...
      const res =
        await axios.get(
          "http:////76d746d1-9c5d-494e-a519-516ce5f4f920.up.railway.app/todaytask",
          {
            params: {
              userid: isloginuser
            }
